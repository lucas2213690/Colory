...
class TurmasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turma" do
    assert_difference('Turma.count') do
      post turmas_url, params: { turma: { cidade: @turma.cidade, curso: @turma.curso, faculdade: @turma.faculdade } }
    end
  ...
  test "should update turma" do
    patch turma_url(@turma), params: { turma: { cidade: @turma.cidade, curso: @turma.curso, faculdade: @turma.faculdade } }
